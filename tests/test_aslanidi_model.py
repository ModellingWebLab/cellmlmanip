...
class TestAslanidiModel:
    ...
    def test_get_derivative_symbols(self, model):
        ...
        assert str(derivs_order[0]) == '_membrane$V'
        assert str(derivs_order[1]) == '_sodium_current_m_gate$m'
        assert str(derivs_order[2]) == '_sodium_current_h1_gate$h1'
        assert str(derivs_order[3]) == '_sodium_current_h2_gate$h2'
        assert str(derivs_order[4]) == '_L_type_Ca_channel_d_L_gate$d_L'
        assert str(derivs_order[5]) == '_L_type_Ca_channel_f_L_gate$f_L'
        assert str(derivs_order[6]) == '_T_type_Ca_channel_d_T_gate$d_T'
        assert str(derivs_order[7]) == '_T_type_Ca_channel_f_T_gate$f_T'
        assert str(derivs_order[8]) == '_Ca_independent_transient_outward_K_current_r_gate$r'
        assert str(derivs_order[9]) == '_Ca_independent_transient_outward_K_current_s1_gate$s1'
        assert str(derivs_order[10]) == '_Ca_independent_transient_outward_K_current_s2_gate$s2'
        assert str(derivs_order[11]) == '_Ca_independent_transient_outward_K_current_s3_gate$s3'
        assert str(derivs_order[12]) == '_delayed_rectifier_K_current_z_gate$z'
        assert str(derivs_order[13]) == '_delayed_rectifier_K_current_pa_gate$p_a'
        assert str(derivs_order[14]) == '_delayed_rectifier_K_current_pi_gate$p_i'
        assert str(derivs_order[15]) == '_intracellular_ion_concentrations$Na_i'
        ...
        assert str(derivs_order[18]) == '_intracellular_Ca_buffering$O_C'
        assert str(derivs_order[19]) == '_intracellular_Ca_buffering$O_TC'
        assert str(derivs_order[20]) == '_intracellular_Ca_buffering$O_TMgC'
        assert str(derivs_order[21]) == '_intracellular_Ca_buffering$O_TMgMg'
        assert str(derivs_order[22]) == '_cleft_space_ion_concentrations$K_c'
        assert str(derivs_order[23]) == '_Ca_handling_by_the_SR$Ca_rel'
        assert str(derivs_order[24]) == '_Ca_handling_by_the_SR$Ca_up'
        assert str(derivs_order[25]) == '_Ca_handling_by_the_SR$O_Calse'
        assert str(derivs_order[26]) == '_Ca_handling_by_the_SR$F1'
        assert str(derivs_order[27]) == '_Ca_handling_by_the_SR$F2'
        assert str(derivs_order[28]) == '_Ca_handling_by_the_SR$F3'
