...
def test_remove_singularities1(expr1):
    ...
    assert str(_remove_singularities(expr1, V, U_offset=1e-5)) == ('(True, Piecewise(((-_-3.4122796460255230 + _V)*(-('
                                                                   ...
                                                                   '2*_V + _5)), True)))')
    assert str(_remove_singularities(expr1, V, exp_function=exp_)) == ('(False, (_6.2*_V - _6.2*(-_5 - log(_6.2))/_2)/'
                                                                       '(_1 - _6.2*exp(_2*_V + _5)))')
    expr = expr1.replace(exp, exp_)
    assert str(_remove_singularities(expr, V, exp_function=exp_)) == ('(True, Piecewise(((-_-3.4122746960255230 + _V)*'
                                                                      '(-(_-3.4122746960255230*_6.2 - _6.2*(-_5 - log('
                                                                      '_6.2))/_2)/(_1 - _6.2*exp_(_-3.4122746960255230'
                                                                      '*_2 + _5)) + (_-3.4122745960255229*_6.2 - _6.2*'
                                                                      '(-_5 - log(_6.2))/_2)/(_1 - _6.2*exp_(_-3.41227'
                                                                      '45960255229*_2 + _5)))/(_-3.4122745960255229 - '
                                                                      '_-3.4122746960255230) + (_-3.4122746960255230*_'
                                                                      '6.2 - _6.2*(-_5 - log(_6.2))/_2)/(_1 - _6.2*exp'
                                                                      '_(_-3.4122746960255230*_2 + _5)), Abs(_-3.41227'
                                                                      '46460255229 - _V) < Abs(_-3.4122745960255229/2 '
                                                                      '- _-3.4122746960255230/2)), ((_6.2*_V - _6.2*(-'
                                                                      '_5 - log(_6.2))/_2)/(_1 - _6.2*exp_(_2*_V + _5)'
                                                                      '), True)))')


def test_remove_singularities2(expr2):
    assert str(_remove_singularities(expr2, V)) == ('(True, Piecewise(((-_-3.4122746960255230 + _V)*(-(_-3.41227469602'
                                                    '55230*_6.2 - _6.2*(-_5 - log(_6.2))/_2)/(-_1 + _6.2*exp(_-3.41227'
                                                    '46960255230*_2 + _5)) + (_-3.4122745960255229*_6.2 - _6.2*(-_5 - '
                                                    'log(_6.2))/_2)/(-_1 + _6.2*exp(_-3.4122745960255229*_2 + _5)))/(_'
                                                    '-3.4122745960255229 - _-3.4122746960255230) + (_-3.41227469602552'
                                                    '30*_6.2 - _6.2*(-_5 - log(_6.2))/_2)/(-_1 + _6.2*exp(_-3.41227469'
                                                    '60255230*_2 + _5)), Abs(_-3.4122746460255229 - _V) < Abs(_-3.4122'
                                                    '745960255229/2 - _-3.4122746960255230/2)), ((_6.2*_V - _6.2*(-_5 '
                                                    '- log(_6.2))/_2)/(-_1 + _6.2*exp(_2*_V + _5)), True)))')


def test_remove_singularities3(expr1):
    assert str(_remove_singularities(1 / expr1, V)) == ('(True, Piecewise(((-_-3.4122746960255230 + _V)*((_1 - _6.2*ex'
                                                        'p(_-3.4122745960255229*_2 + _5))/(_-3.4122745960255229*_6.2 -'
                                                        ' _6.2*(-_5 - log(_6.2))/_2) - (_1 - _6.2*exp(_-3.412274696025'
                                                        '5230*_2 + _5))/(_-3.4122746960255230*_6.2 - _6.2*(-_5 - log(_'
                                                        '6.2))/_2))/(_-3.4122745960255229 - _-3.4122746960255230) + (_'
                                                        '1 - _6.2*exp(_-3.4122746960255230*_2 + _5))/(_-3.412274696025'
                                                        '5230*_6.2 - _6.2*(-_5 - log(_6.2))/_2), Abs(_-3.4122746460255'
                                                        '229 - _V) < Abs(_-3.4122745960255229/2 - _-3.4122746960255230'
                                                        '/2)), ((_1 - _6.2*exp(_2*_V + _5))/(_6.2*_V - _6.2*(-_5 - log'
                                                        '(_6.2))/_2), True)))')


def test_remove_singularities4(expr2):
    assert str(_remove_singularities(1 / expr2, V)) == ('(True, Piecewise(((-_-3.4122746960255230 + _V)*((-_1 + _6.2*e'
                                                        'xp(_-3.4122745960255229*_2 + _5))/(_-3.4122745960255229*_6.2 '
                                                        '- _6.2*(-_5 - log(_6.2))/_2) - (-_1 + _6.2*exp(_-3.4122746960'
                                                        '255230*_2 + _5))/(_-3.4122746960255230*_6.2 - _6.2*(-_5 - log'
                                                        '(_6.2))/_2))/(_-3.4122745960255229 - _-3.4122746960255230) + '
                                                        '(-_1 + _6.2*exp(_-3.4122746960255230*_2 + _5))/(_-3.412274696'
                                                        '0255230*_6.2 - _6.2*(-_5 - log(_6.2))/_2), Abs(_-3.4122746460'
                                                        '255229 - _V) < Abs(_-3.4122745960255229/2 - _-3.4122746960255'
                                                        '230/2)), ((-_1 + _6.2*exp(_2*_V + _5))/(_6.2*_V - _6.2*(-_5 -'
                                                        ' log(_6.2))/_2), True)))')
...
def test_remove_singularities5(expr1):  # Try with numbers in place of Quantity Dummies
    ...
    assert str(_remove_singularities(expr, V)) == ('(True, Piecewise(((-_-3.41227469602552 + _V)*(-(6.2*_-3.4122746960'
                                                   '2552 + 21.1561028053582)/(1.0 - 920.161586435975*exp(2.0*_-3.41227'
                                                   '469602552)) + (6.2*_-3.41227459602552 + 21.1561028053582)/(1.0 - 9'
                                                   '20.161586435975*exp(2.0*_-3.41227459602552)))/(_-3.41227459602552 '
                                                   '- _-3.41227469602552) + (6.2*_-3.41227469602552 + 21.1561028053582'
                                                   ')/(1.0 - 920.161586435975*exp(2.0*_-3.41227469602552)), Abs(_-3.41'
                                                   '227464602552 - _V) < Abs(_-3.41227459602552/2 - _-3.41227469602552'
                                                   '/2)), ((6.2*_V + 21.1561028053582)/(1.0 - 920.161586435975*exp(2.0'
                                                   '*_V)), True)))')
