# -*- coding: utf-8 -*-
#
# Cellmlmanip documentation build configuration file, based on one created by
# sphinx-quickstart.
#
...
# built documents.
#
version = release = cellmlmanip.__version__
...
htmlhelp_basename = 'CellMLManipDocs'
...
latex_documents = [
    (master_doc, 'Cellmlmanip.tex', u'Cellmlmanip Documentation',
     u'Cellmlmanip authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellmlmanip', u'Cellmlmanip Documentation',
     [author], 1)
]
