...
def load_model(path, unit_store=None, skip_singularity_fixes=False):
    ...
    """
    return Parser(path).parse(unit_store=unit_store, skip_singularity_fixes=skip_singularity_fixes)
